    ...
    return (
        <div className="password-wrapper">
            <div className="password">
                <span className={`text-preset-2 new-text-preset-1 ${password ? 'text-grey-200' : 'text-grey-700'}`}>{password ? password : 'P4$5W0rD!'}</span>
                <div className='copy text-green-200'>
                    <span className=' text-preset-4 new-text-preset-3 '>  {copy ? 'COPIED' : ''}</span>
                    <svg width="21" height="24" xmlns="http://www.w3.org/2000/svg" style={{ cursor: 'pointer' }} onClick={handleCopy}>
